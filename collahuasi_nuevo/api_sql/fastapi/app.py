...
from routes.drive_data              import router as drive_data
from routes.mantenimientodb_router  import router as mantenimientodb_router
from routes.mimosa_data_router      import router as mimosa_data_router
from routes.api_info_router         import router as api_info_router
from routes.iperf3_results          import router as iperf3_results
...
app.include_router(mantenimientodb_router, prefix="/mantenimientodb", tags=["Mantenimiento DB"], include_in_schema=False)
app.include_router(mimosa_data_router, prefix="/mimosa_data", tags=["Datos Mimosa"])
app.include_router(api_info_router, prefix="/api", tags=["API info"])
app.include_router(iperf3_results, prefix="/iperf3", tags=["Iperf3 Results"])
